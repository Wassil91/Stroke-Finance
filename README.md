...
Stroke finance est un projet d'architecture Base de donnée.Dans ce projet nous allons travailler avec le site de LA CENTRALE afin de prendre les données des véhicule (Modele , prix ,année , région) en coorélation avec leur cotation bourssière . 
